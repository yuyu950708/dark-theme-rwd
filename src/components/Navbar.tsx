            ...
            {isOpen && (
              <main className={style.popo}>
                <section className={style.sec}>
                  ...
                  <p className={style.text}>Download the app in AppStore, Google Play or Microsoft Store.</p>
                  ...
                  <br />
                  <button onClick={() => setIsOpen(!true)}  className={style.btn}>Fack Downnload</button>
                  <button className={style.x}  onClick={() => setIsOpen(!true)}><TbXboxX /></button>
                </section>
              </main>
            )}
        <section>
